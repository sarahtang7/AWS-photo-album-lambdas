...
bucket_url = 'https://s3.amazonaws.com/photo-album-application.com/'

def get_imgs(label):
    search_url = 'https://search-photos2-iso42y4zytwc3luoezg7cfftpe.us-east-1.es.amazonaws.com/photos/_search?q='
    print('label:', label)
